  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
      <div className="flex flex-col" >
        ...
        <input type="text" placeholder='Digite seu nome' className="rounded-lg py-2 text-sm placeholder:text-sm placeholder:text-stone-400" value={name} onChange={(e) => setName(e.target.value)} />
        {errors?.name && (
      ...
      <div className="flex flex-col" >
        ...
        <input type="email" placeholder='Digite seu e-mail' className="rounded-lg py-2 text-sm placeholder:text-sm placeholder:text-stone-400" value={email} onChange={(e) => setEmail(e.target.value)} />
         {errors?.email && (
